...
export const KATALOG = [
  ...
  // Değerler üretici kataloğu TECHNICAL DETAILS + gövde metninden BİREBİR:
  ...
  { ad: 'AquaVARIO 151', pn: null, arketip: 'vario', grup: 'animasyon',
  ...
  { ad: 'AquaVARIO 241', pn: null, arketip: 'vario', grup: 'animasyon',
  ...
  { ad: 'AquaSWITCH', pn: null, arketip: 'switch', grup: 'animasyon',
  ...
  { ad: 'AquaJUMP', pn: null, arketip: 'laminer', grup: 'animasyon',
    etiket: 'AquaJUMP', teknik: { guc: '40 W' }, isikModul: '412C',
    kontrol: 'solenoid', montaj412: 'nozul-ici-halka',
    dmx: { mantiksal: ['master', 'hue', 'beyaz'], resmi: null },
    not: 'laminar jumping jet' },
  { ad: 'AquaJUMP GIANT', pn: null, arketip: 'laminer', grup: 'animasyon',
    etiket: 'JUMP GIANT', teknik: { guc: '40 W' }, isikModul: '412C',
    kontrol: 'solenoid', montaj412: 'nozul-ici-halka',
    yon: { nozulMm: [12, 16] },
    dmx: { mantiksal: ['master', 'hue', 'beyaz'], resmi: null },
    not: 'RGBW-LED; Ø12/16mm parabol' },
  { ad: 'AquaROBO', pn: null, arketip: 'robo', grup: 'animasyon',
  ...
  { ad: 'AquaROBO-ROLL', pn: null, arketip: 'robo', grup: 'animasyon',
    etiket: 'ROBO-ROLL', teknik: { guc: '72 W' },
    kontrol: 'surekli', yon: { pan: [-90, 90], tilt: [0, 45] },
    dmx: { mantiksal: ['master', 'hiz', 'hue', 'beyaz', 'pan', 'tilt'], resmi: null },
    not: 'servo 3-eksen (X/Y/Z)' },
  { ad: 'AquaSWING', pn: null, arketip: 'swing', grup: 'animasyon',
  ...
  { ad: 'AquaSTAR', pn: null, arketip: 'star', grup: 'animasyon',
  ...
  { ad: 'AquaPOP JET', pn: null, arketip: 'pop', grup: 'animasyon',
  ...
  { ad: 'AquaPULSE', pn: null, arketip: 'swing', grup: 'animasyon',
    etiket: 'AquaPULSE', teknik: { guc: '24 W' }, not: 'servo dalga efekti' },
  { ad: 'AquaTORCH', pn: null, arketip: 'torch', grup: 'animasyon',
  ...
  { ad: 'CLASSIC WATER CURTAIN', pn: null, arketip: 'perde', grup: 'perde',
  ...
  { ad: 'LACE WATER CURTAIN', pn: null, arketip: 'perde', grup: 'perde',
  ...
  { ad: 'DIGITAL WATER CURTAIN', pn: null, arketip: 'perde', grup: 'perde',
  ...
  { ad: 'AquaSHIELD I', pn: null, arketip: 'yelpaze', grup: 'perde',
  ...
  // geniş olanı).
  { ad: 'AquaLIGHT 412', pn: null, arketip: 'rgb_spot', grup: 'isik',
  ...
  { ad: 'AquaLIGHT 412C', pn: null, arketip: 'rgb_spot', grup: 'isik',
  ...
  { ad: 'AquaLIGHT 406', pn: null, arketip: 'rgb_spot', grup: 'isik',
  ...
  { ad: 'AquaLIGHT 406C', pn: null, arketip: 'rgb_spot', grup: 'isik',
